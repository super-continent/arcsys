...
/// Hitbox data for GGXrd
#[derive(Debug)]
pub struct GGXrdJonBin {
...
impl GGXrdJonBin {
    pub fn parse(jonbin: &[u8]) -> Result<GGXrdJonBin, Error> {
...
fn parse_jonbin_impl(i: &[u8]) -> IResult<&[u8], GGXrdJonBin> {
    let (i, _) = tag(GGXrdJonBin::MAGIC_JONB)(i)?;
